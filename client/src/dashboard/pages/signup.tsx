...
import { Card, CardContent, CardHeader, CardTitle, CardDescription, CardFooter } from "@dashboard/components/ui/card";
...
import type { UserRole, LeagueBand } from "@dashboard/lib/types";
import { LEAGUE_BANDS } from "@dashboard/lib/types";
