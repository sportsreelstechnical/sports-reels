...
-- This enables advanced AI video analysis with player tracking and performance metrics
...
-- Player detections table for face tracking
...
-- Player actions table for movement and skill analysis
...
-- Performance metrics table for comprehensive analysis
...
-- RLS Policies: Users can access their own video analysis data
