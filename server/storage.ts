...
export interface IStorage {
  ...
  // Player Photos
  getPlayerPhotos(playerId: string): Promise<PlayerPhoto[]>;
  createPlayerPhoto(photo: InsertPlayerPhoto): Promise<PlayerPhoto>;
  deletePlayerPhoto(id: string): Promise<void>;

  getEmbassyProfile(id: string): Promise<EmbassyProfile | undefined>;
  getEmbassyProfileByCountry(
    country: string
  ): Promise<EmbassyProfile | undefined>;
  getEmbassyProfileByUserId(
    userId: string
  ): Promise<EmbassyProfile | undefined>;
  ...
  getPlayerInternationalRecords(
    playerId: string
  ): Promise<PlayerInternationalRecord[]>;
  getPlayerInternationalRecord(
    id: string
  ): Promise<PlayerInternationalRecord | undefined>;
  createPlayerInternationalRecord(
    record: InsertPlayerInternationalRecord
  ): Promise<PlayerInternationalRecord>;
  updatePlayerInternationalRecord(
    id: string,
...
export class DatabaseStorage implements IStorage {
  ...
  async getTransferReports(teamId: string): Promise<TransferReport[]> {
    return db
      ...
      .orderBy(desc(transferReports.generatedAt));
  }
  ...
  async getEmbassyVerifications(
    ...
    return db
      .select()
      .from(embassyVerifications)
      .orderBy(desc(embassyVerifications.submittedAt));
  }
  ...
  async getScoutingInquiries(teamId?: string): Promise<ScoutingInquiry[]> {
    return db
      ...
      .orderBy(desc(scoutingInquiries.createdAt));
  }
  ...
  async getInvitationLetters(playerId: string): Promise<InvitationLetter[]> {
    return db
      ...
      .orderBy(desc(invitationLetters.uploadedAt));
  }
  ...
  async getAllInvitationLetters(teamId?: string): Promise<InvitationLetter[]> {
    if (teamId) {
      return db
        .select()
        .from(invitationLetters)
        .where(eq(invitationLetters.fromTeamId, teamId))
        .orderBy(desc(invitationLetters.uploadedAt));
    }
    return db
      .select()
  ...
  async getConsularReports(playerId: string): Promise<ConsularReport[]> {
    return db
      ...
      .orderBy(desc(consularReports.generatedAt));
  }
  ...
  async getSharedVideos(userId: string): Promise<SharedVideo[]> {
    return db
      ...
      .orderBy(desc(sharedVideos.sharedAt));
  }
  ...
  async getTransferTargets(playerId: string): Promise<TransferTarget[]> {
    return db
      ...
      .orderBy(desc(transferTargets.createdAt));
  }
  ...
  async getVideoPlayerTags(videoId: string): Promise<VideoPlayerTag[]> {
    return db
      ...
      .orderBy(desc(videoPlayerTags.createdAt));
  }
  ...
  async getPlayerDocuments(playerId: string): Promise<PlayerDocument[]> {
    return db
      ...
      .orderBy(desc(playerDocuments.uploadedAt));
  }
  ...
  async getFederationLetterRequestByNumber(
    requestNumber: string
  ): Promise<FederationLetterRequest | undefined> {
    const [request] = await db
      .select()
      .from(federationLetterRequests)
      .where(eq(federationLetterRequests.requestNumber, requestNumber));
    return request;
  }
  ...
  async getFederationLetterRequestsByPlayer(
    playerId: string
  ): Promise<FederationLetterRequest[]> {
    return db
      .select()
      .from(federationLetterRequests)
      .where(eq(federationLetterRequests.playerId, playerId))
      .orderBy(desc(federationLetterRequests.createdAt));
  }

  async getIssuedFederationLettersByPlayer(
    playerId: string
  ): Promise<FederationLetterRequest[]> {
    return db
      .select()
      ...
      .where(
        and(
          eq(federationLetterRequests.playerId, playerId),
  ...
  async getAllIssuedFederationLetters(): Promise<FederationLetterRequest[]> {
    return db
      .select()
      .from(federationLetterRequests)
      .where(eq(federationLetterRequests.status, "issued"))
      .orderBy(desc(federationLetterRequests.issuedAt));
  }

  async getFederationLetterRequestsByStatus(
    status: string
  ): Promise<FederationLetterRequest[]> {
    return db
      .select()
      .from(federationLetterRequests)
      .where(eq(federationLetterRequests.status, status))
      .orderBy(desc(federationLetterRequests.createdAt));
  }
  ...
  async getFederationProfiles(): Promise<FederationProfile[]> {
    return db
      ...
      .orderBy(desc(federationProfiles.createdAt));
  }
  ...
  async updateFederationProfile(
    id: string,
    updates: Partial<InsertFederationProfile>
  ): Promise<FederationProfile | undefined> {
    const [profile] = await db
      .update(federationProfiles)
      .set({ ...updates, updatedAt: new Date() })
      .where(eq(federationProfiles.id, id))
      .returning();
    return profile;
  ...
  async getFederationFeeSchedules(
    ...
    return db
      ...
      .orderBy(desc(federationFeeSchedules.createdAt));
  }
  ...
  async getFederationFeeScheduleByCountry(
    federationId: string,
    country: string
    ...
    const [schedule] = await db
      ...
      .where(
        and(
          eq(federationFeeSchedules.federationId, federationId),
          eq(federationFeeSchedules.country, country),
          eq(federationFeeSchedules.isActive, true)
        )
      );
    return schedule;
  }
  ...
  async getFederationDashboardStats(federationId?: string): Promise<{
  ...
  async getUnreadMessagesForPortal(
    portal: string
  ): Promise<FederationRequestMessage[]> {
    return db
      .select()
      ...
      .where(
        and(
          eq(federationRequestMessages.recipientPortal, portal),
          eq(federationRequestMessages.isRead, false)
        )
      )
      .orderBy(desc(federationRequestMessages.createdAt));
  }
  ...
  async getFederationIssuedDocuments(
    ...
    return db
      ...
      .orderBy(desc(federationIssuedDocuments.createdAt));
  }

  async createFederationIssuedDocument(
    document: InsertFederationIssuedDocument
  ): Promise<FederationIssuedDocument> {
    const [newDoc] = await db
  ...
  async getRequestWithFullHistory(requestId: string): Promise<{
    ...
    const [request] = await db
      .select()
      .from(federationLetterRequests)
      .where(eq(federationLetterRequests.id, requestId));
  ...
  async getScoutShortlistWithPlayers(
    ...
    const shortlistEntries = await db
      .select()
      .from(scoutShortlists)
      .where(eq(scoutShortlists.scoutId, scoutId))
      .orderBy(desc(scoutShortlists.addedAt));
  ...
  async getShortlistEntry(
    ...
    const [entry] = await db
      ...
      .where(
        and(
          eq(scoutShortlists.scoutId, scoutId),
          eq(scoutShortlists.playerId, playerId)
        )
      );
    return entry;
  }
  ...
  async getTokenPacks(): Promise<TokenPack[]> {
    return db
      .select()
      .from(tokenPacks)
      .where(eq(tokenPacks.isActive, true))
      .orderBy(tokenPacks.sortOrder);
  }
  ...
  async getPlayerShareLinks(playerId: string): Promise<PlayerShareLink[]> {
    return db
      ...
      .orderBy(desc(playerShareLinks.createdAt));
  }
  ...
  async getAllEmbassyNotifiedLetters(): Promise<InvitationLetter[]> {
    return db
      .select()
      .from(invitationLetters)
      .where(eq(invitationLetters.embassyNotificationStatus, "notified"))
      .orderBy(desc(invitationLetters.embassyNotifiedAt));
  }
  ...
  async getAllEmbassyProfiles(): Promise<EmbassyProfile[]> {
    return db
      .select()
      .from(embassyProfiles)
      .orderBy(desc(embassyProfiles.createdAt));
  }
  ...
  async getPlatformStats(): Promise<{
    ...
    const [embassyStats] = await db
      .select({ count: sql<number>`count(*)` })
      .from(users)
      .where(eq(users.role, "embassy"));
    const [federationStats] = await db
      .select({ count: sql<number>`count(*)` })
      .from(users)
      .where(eq(users.role, "federation"));
